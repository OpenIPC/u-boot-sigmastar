...
/* Process a SOFn marker */
{
    ...
    TRACEMS4(cinfo, 1, JTRC_SOF, cinfo->unread_marker, (int)cinfo->image_width, (int)cinfo->image_height,
    ...
    for (ci = 0; ci < cinfo->num_components; ci++)
    {
        ...
        TRACEMS4(cinfo, 1, JTRC_SOF_COMPONENT, compptr->component_id, compptr->h_samp_factor, compptr->v_samp_factor,
...
/* Process a DHT marker */
{
    ...
    while (length > 16)
    {
        ...
        TRACEMS8(cinfo, 2, JTRC_HUFFBITS, bits[9], bits[10], bits[11], bits[12], bits[13], bits[14], bits[15],
                 bits[16]);
 ...
 */
{
        ...
        && GETJOCTET(data[2]) == 0x49 && GETJOCTET(data[3]) == 0x46 && GETJOCTET(data[4]) == 0)
    {
        ...
        TRACEMS5(cinfo, 1, JTRC_JFIF, cinfo->JFIF_major_version, cinfo->JFIF_minor_version, cinfo->X_density,
