/*
* eMMC_infinity7_uboot.h- Sigmastar
*
...
#ifndef __eMMC_INFINITY7_UBOOT__
#define __eMMC_INFINITY7_UBOOT__
...
#define CONFIG_SELECT_EMMC0              0
#define CONFIG_SELECT_EMMC1              0
#define CONFIG_SELECT_EMMC2              0
#define CONFIG_SELECT_EMMC3              1

#if CONFIG_SELECT_EMMC3
#define ONLY_4_BITS_MODE                (0)
#else
#define ONLY_4_BITS_MODE                (1)
#endif

#if CONFIG_SELECT_EMMC3
#define REG_BANK_FCIE0                  0x20D00U //sd3:x141A
#define REG_BANK_FCIE1                  0x20D80U //sd1:x141B
#define REG_BANK_FCIE2                  0x20E00U //sd2:x141C

#elif CONFIG_SELECT_EMMC1
#define REG_BANK_FCIE0                  0x20800U //sdio0:x1410
#define REG_BANK_FCIE1                  0x20880U //sdio1:x1411
#define REG_BANK_FCIE2                  0x20900U //sdio2:x1412

#elif CONFIG_SELECT_EMMC2
#define REG_BANK_FCIE0                  0x20B00U //sd3:x1416
#define REG_BANK_FCIE1                  0x20B80U //sd1:x1417
#define REG_BANK_FCIE2                  0x20C00U //sd2:x1418
...
#if CONFIG_SELECT_EMMC3
#define reg_ckg_fcie_VALUE                  (0x25)
#define CLKGEN0_BASE                    GET_REG_ADDR(RIU_BASE, REG_BANK_CLKGEN2)
#elif CONFIG_SELECT_EMMC2
#define reg_ckg_fcie_VALUE                  (0x24)
#define CLKGEN0_BASE                    GET_REG_ADDR(RIU_BASE, REG_BANK_CLKGEN2)
#elif CONFIG_SELECT_EMMC1
#define reg_ckg_fcie_VALUE                  (0x45)
...
#define reg_ckg_fcie                    GET_REG_ADDR(CLKGEN0_BASE, reg_ckg_fcie_VALUE)
...
#if CONFIG_SELECT_EMMC3
#define BIT_CKG_SD_VALUE            (BIT5)
#elif CONFIG_SELECT_EMMC2
#define BIT_CKG_SD_VALUE            (BIT4)
#elif CONFIG_SELECT_EMMC1
#define BIT_CKG_SD_VALUE            (BIT3)
#else
...
#define REG_BANK_GPIO2                  0x8200  // (0x1104 - 0x1000) x 80h GPIO2  BK:x1104
...
#define PAD_PADGPIO2_BASE               GET_REG_ADDR(RIU_BASE, REG_BANK_GPIO2)   //PAD_GPIO2
...
#if CONFIG_SELECT_EMMC1
#define reg_emmc_config                 GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x67)
#define BIT_EMMC_MODE_1                 (BIT12)
#elif CONFIG_SELECT_EMMC2
#define reg_emmc_config                 GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x4d)
#define BIT_EMMC_MODE_1                 (BIT1)

#elif CONFIG_SELECT_EMMC3
#define reg_emmc_config                 GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x61)
#define BIT_EMMC_MODE_1                 (BIT0)
#define BIT_EMMC_MODE_8X                (BIT2|BIT_EMMC_RST) //[8]reg_emmc0_8b_mode

#else
#define reg_emmc_config                 GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x67)
#define BIT_EMMC_MODE_1                 (BIT8|BIT_EMMC_RST) //[1:0]reg_emmc0_4b_mode   [5:4]reg_emmc0_rst_mode

#endif

//---------------------------------ddr mode------------------------------------
#define BIT_PAD_IN_SDR                  (BIT_PAD_CLK_SEL|BIT_PAD_IN_SEL_SD)
...
#if CONFIG_SELECT_EMMC3
#define BIT_IMI_SEL                     (0x30)
#elif CONFIG_SELECT_EMMC2
#define BIT_IMI_SEL                     (0x20)
#elif CONFIG_SELECT_EMMC1
#define BIT_IMI_SEL                     (0x10)
#else
#define BIT_IMI_SEL                     (0x00)
#endif
#define REG_BANK_FCIE0_ip0              0x20980U //sd0:x1413
#define FCIE0_IP0_BASE                  GET_REG_ADDR(RIU_BASE, REG_BANK_FCIE0_ip0)
#define IP_ACCESS_IMI_EN()              {REG_FCIE(GET_REG_ADDR(FCIE0_IP0_BASE,0x30)) = BIT_IMI_SEL;}
