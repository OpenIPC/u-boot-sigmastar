...
METHODDEF(void)
process_data_simple_main JPP((j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr,
                              JDIMENSION out_rows_avail));
METHODDEF(void)
process_data_context_main JPP((j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr,
                               JDIMENSION out_rows_avail));
 ...
 */
{
     ...
     */
    mainp->xbuffer[0] = (JSAMPIMAGE)(*cinfo->mem->alloc_small)((j_common_ptr)cinfo, JPOOL_IMAGE,
                         ...
                         JDIMENSION out_rows_avail)
{
    ...
    (*cinfo->post->post_process_data)(cinfo, mainp->buffer, &mainp->rowgroup_ctr, mainp->rowgroups_avail, output_buf,
                          ...
                          JDIMENSION out_rows_avail)
{
    ...
    switch (mainp->context_state)
    {
        case CTX_POSTPONED_ROW:
            ...
            (*cinfo->post->post_process_data)(cinfo, mainp->xbuffer[mainp->whichptr], &mainp->rowgroup_ctr,
                                              mainp->rowgroups_avail, output_buf, out_row_ctr, out_rows_avail);
            if (mainp->rowgroup_ctr < mainp->rowgroups_avail)
...
process_data_crank_post(j_decompress_ptr cinfo, JSAMPARRAY output_buf, JDIMENSION *out_row_ctr,
                        JDIMENSION out_rows_avail)
{
    (*cinfo->post->post_process_data)(cinfo, (JSAMPIMAGE)NULL, (JDIMENSION *)NULL, (JDIMENSION)0, output_buf,
                                      out_row_ctr, out_rows_avail);
}
...
jinit_d_main_controller(j_decompress_ptr cinfo, boolean need_full_buffer)
{
    ...
    for (ci = 0, compptr = cinfo->comp_info; ci < cinfo->num_components; ci++, compptr++)
    {
        ...
        mainp->buffer[ci] = (*cinfo->mem->alloc_sarray)(
            (j_common_ptr)cinfo, JPOOL_IMAGE, compptr->width_in_blocks * ((JDIMENSION)compptr->DCT_h_scaled_size),
