...
// INIT_HDMITX_ATOP
//****************************************************
u16 g_stinithdmitxatopcommontbl[INIT_HDMITX_ATOP_COMMON_REG_NUM][REG_TBL_ADDR_SIZE + REG_TBL_MASK_SIZE + REG_TBL_DATA_SIZE] = 
    {
    { DRV_REG(REG_HDMI_TX_ATOP_17_L),/* HDMI_TX_ATOP_REG_DISCDET_EN_CH */
   0xFF, 0x08,
    },
    { DRV_REG(REG_HDMI_TX_ATOP_20_L),/* HDMI_TX_ATOP_REG_GCR_ICTRL_SEL_TAP0_CH0, HDMI_TX_ATOP_REG_RESERVED_20_0, HDMI_TX_ATOP_REG_GCR_ICTRL_SEL_TAP0_CH1, HDMI_TX_ATOP_REG_RESERVED_20_1 */
   0xffff, 0x0,
    },
    { DRV_REG(REG_HDMI_TX_ATOP_21_L),/* HDMI_TX_ATOP_REG_GCR_ICTRL_SEL_TAP0_CH2, HDMI_TX_ATOP_REG_RESERVED_21_0, HDMI_TX_ATOP_REG_GCR_ICTRL_SEL_TAP0_CH3, HDMI_TX_ATOP_REG_RESERVED_21_1 */
   0xffff, 0x0,
    },
   ...
   0xFF, 0x00,
    ...
    { DRV_REG(REG_HDMI_TX_ATOP_39_L),/* HDMI_TX_ATOP_REG_GCR_PREDRV_SLEWRATE_CTRL_CH0, HDMI_TX_ATOP_REG_RESERVED_39_0, HDMI_TX_ATOP_REG_GCR_PREDRV_SLEWRATE_CTRL_CH1, HDMI_TX_ATOP_REG_RESERVED_39_1, HDMI_TX_ATOP_REG_GCR_PREDRV_SLEWRATE_CTRL_CH2, HDMI_TX_ATOP_REG_RESERVED_39_2, HDMI_TX_ATOP_REG_GCR_PREDRV_SLEWRATE_CTRL_CH3, HDMI_TX_ATOP_REG_RESERVED_39_3 */
   0xffff, 0x3333,
    },
   ...
   0xffff, 0x0,
    ...
    { DRV_REG(REG_HDMI_TX_ATOP_1C_L),/* HDMI_TX_ATOP_REG_GCR_HDMITXPLL_LOOP_DIV_FIRST, HDMI_TX_ATOP_REG_RESERVED_1C, HDMI_TX_ATOP_REG_GCR_HDMITXPLL_LOOP_DIV_SECOND */
   0xffff, 0x501,
    },
    { DRV_REG(REG_HDMI_TX_ATOP_1B_L),/* HDMI_TX_ATOP_REG_GCR_EN_HDMITXPLL_TEST, HDMI_TX_ATOP_REG_GCR_EN_HDMITXPLL_XTAL, HDMI_TX_ATOP_REG_GCR_HDMITXPLL_CP_SW, HDMI_TX_ATOP_REG_GCR_HDMITXPLL_DAC_DIV, HDMI_TX_ATOP_REG_RESERVED_1B_0, HDMI_TX_ATOP_REG_GCR_HDMITXPLL_ICTRL, HDMI_TX_ATOP_REG_RESERVED_1B_1, HDMI_TX_ATOP_REG_GCR_HDMITXPLL_INPUT_DIV */
   0xffff, 0x220,
    },
   ...
   0xffff, 0x1111,
    ...
    { DRV_REG(REG_HDMI_TX_ATOP_50_L),/* HDMI_TX_ATOP_REG_GCR_SER_36BIT_MODE_CH0, HDMI_TX_ATOP_REG_GCR_SER_36BIT_MODE_CH1, HDMI_TX_ATOP_REG_GCR_SER_36BIT_MODE_CH2, HDMI_TX_ATOP_REG_GCR_SER_36BIT_MODE_CH3, HDMI_TX_ATOP_REG_GCR_DIV_EN */
   0xffff, 0x100,
    },
    { DRV_REG(REG_HDMI_LTP_03_L),/* HDMI_LTP_REG_HDMI_14_OUT_SEL, HDMI_LTP_REG_HDMI_14_FIFO_CLEAR_EN, HDMI_LTP_REG_HDMI_14_SKIP_DATA, HDMI_LTP_REG_HDMI_14_OFF_DATA */
   0xFF, 0x02,
    },
};
...
u16 g_stinithdmitxatoptbl[INIT_HDMITX_ATOP_REG_NUM][REG_TBL_ADDR_SIZE + REG_TBL_MASK_SIZE + E_HAL_HDMITX_ID_NUM] = 
{
   ...
   0xffff,           0x2828,/*720_24P*/
           ...
           0x2828,/*1280x800_60P*/
           0x2828,/*1280x960_60P*/
           0x2828,/*1280x1024_60P*/
           0x2828,/*1360x768_60P*/
           0x2828,/*1366x768_60P*/
           0x2828,/*1400x1050_60P*/
           0x2828,/*1440x900_60P*/
           0x2828,/*1600x900_60P*/
           0x2828,/*1600x1200_60P*/
           0x2828,/*1680x1050_60P*/
           0x2828,/*1920x1200_60P*/
           0x2b2b,/*1920x1440_60P*/
