...
void _DrvPnlIfTransUnifiedParamToHal(MhalPnlUnifiedParamConfig_t *pstMhalCfg, HalPnlUnifiedParamConfig_t *pstHalCfg)
{
    ...
    pstHalCfg->stRgbDataInfo.eRgbDtype = pstMhalCfg->stRgbDataInfo.eRgbDtype == E_MHAL_PNL_RGB_DTYPE_RGB888 ? E_HAL_PNL_RGB_DTYPE_RGB888:
...
void _DrvPnlIfTransUnifiedParamToMhal(MhalPnlUnifiedParamConfig_t *pstMhalCfg, HalPnlUnifiedParamConfig_t *pstHalCfg)
{
    ...
    pstMhalCfg->stRgbDataInfo.eRgbDtype = pstHalCfg->stRgbDataInfo.eRgbDtype == E_HAL_PNL_RGB_DTYPE_RGB888 ? E_MHAL_PNL_RGB_DTYPE_RGB888:
