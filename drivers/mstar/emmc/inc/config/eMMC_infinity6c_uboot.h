/*
* eMMC_infinity6c_uboot.h- Sigmastar
*
...
#ifndef __eMMC_INFINITY6C_UBOOT__
#define __eMMC_INFINITY6C_UBOOT__
...
#define CONFIG_SELECT_EMMC1              1
#define CONFIG_SELECT_EMMC2              0
#define CONFIG_SELECT_EMMC3              0
...
#define BIT_MIE_FUNC_ENABLE             BIT_EMMC_EN //I6E:BIT_SDIO_MOD OTHERS:BIT_SD_EN
...
#define CLKGEN0_BASE                    GET_REG_ADDR(RIU_BASE, REG_BANK_CLKGEN2)
#elif CONFIG_SELECT_EMMC1
#define reg_ckg_fcie_VALUE                  (0x4b)
...
#define BIT_SD_MODE_MASK                (BIT8|BIT9|BIT10|BIT11|BIT12|BIT13)
...
#define reg_emmc_config                 GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x61)
#define BIT_EMMC_MODE_1                 (BIT9|BIT_EMMC_RST)
...
#define BIT_PAD_IN_SDR                  (BIT_PAD_IN_RDY_SEL|BIT_PRE_FULL_SEL0|BIT_PRE_FULL_SEL1)
...
#endif /* __eMMC_MERCURY6P_UBOOT__ */
