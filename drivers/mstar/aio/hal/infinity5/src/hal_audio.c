...
static void _HalAudDmaSetMiuSel(AudDmaChn_e eDmaChannel, U32 nBufAddrOffset)
{
    ...
    switch(eDmaChannel)
    {
        ...
        default:
            printf("_HalAudDmaSetMiuSel - ERROR [%s ## %d] \n", __func__, __LINE__);
            break;
    }
    ...
    switch(eDmaChannel)
    {
        ...
        case AUD_DMA_WRITER2:
            ...
            switch(eRate)
            {
                ...
                default:
                    printf("Function - %s # %d - AUD_DMA_WRITER2 eRate = %d, error !] \n", __func__, __LINE__, (int)eRate);
                    return FALSE;
            }
#endif
            break;
        ...
        case AUD_DMA_READER2:
            ...
            switch(eRate)
            {
                ...
                default:
                    printf("Function - %s # %d - AUD_DMA_READER2 eRate = %d, error !] \n", __func__, __LINE__, (int)eRate);
                    return FALSE;
            }
            break;
...
{
    printf("Function - %s # %d - have NOT support yet, warning !] \n", __func__, __LINE__);
...
BOOL HalAudDigMicSetRate(AudRate_e eRate)
{
    ...
    switch(eRate)
    {
        ...
        default:
            printf("Function - %s # %d - DigMic eRate = %d, error !] \n", __func__, __LINE__, (int)eRate);
            return FALSE;
    }
...
BOOL HalAudDigMicSetGain(S8 s8Gain, S8 ch)
{
    ...
    if(s8Gain>4)
    {
        printf("Function - %s # %d - s8Gain = %d, error !] \n", __func__, __LINE__, s8Gain);
        return FALSE;
    }
    else
    {
    ...
    {
        printf("Function - %s # %d - ch = %d, error !] \n", __func__, __LINE__, ch);
        return FALSE;
    }
