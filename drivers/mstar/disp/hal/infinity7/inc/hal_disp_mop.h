...
INTERFACE void HalDispMopSetYDmaThreshold(HalDispMopId_e enMopId, u8 u8Threshold);
INTERFACE void HalDispMopSetCDmaThreshold(HalDispMopId_e enMopId, u8 u8Threshold);
