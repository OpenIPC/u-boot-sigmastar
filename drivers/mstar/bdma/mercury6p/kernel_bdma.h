...
typedef struct KeBdma_s
{
    ...
    u32 reg_ch0_src_sel             :4;
        ...
        #define REG_BDMA_SRC_MSPI0          7  //16 bytes
        #define REG_BDMA_SRC_MSPI1          10 //16 bytes
    ...
    u32 reg_ch0_dst_sel             :4;
        ...
        #define REG_BDMA_DST_MSPI0          7
        #define REG_BDMA_DST_SEC51          9
        #define REG_BDMA_DST_MSPI1          10
    ...
    u32                             :16;
    // 0x1a
    u32 reg_ch0_src_a_msb4          :4;
    u32                             :28;
    // 0x1b
    u32 reg_ch0_dst_a_msb4          :4;
    u32                             :28;
} KeBdma_t;
