/*
* snr_cfg_infinity6b0.c- Sigmastar
*
...
#define VIFTOP_REG_BASE                     (0x1F260800)    // 0x1304
...
#define CHIPTOP_TO_TEST_IN_MODE_REG_OFST    (0x12)
#define CHIPTOP_TO_TEST_IN_MODE_REG_MASK    (0x0001)
...
void Set_SNR_IOPad(int mode)
{
    ...
    u16RegReadVal |= ( (0 << 4) & CHIPTOP_TO_CCIR_MODE_REG_MASK);
    REG_WRITE(CHIPTOP_REG_BASE, CHIPTOP_TO_CCIR_MODE_REG_OFST, u16RegReadVal);

    u16RegReadVal = REG_READ(CHIPTOP_REG_BASE, CHIPTOP_TO_TEST_IN_MODE_REG_OFST); //ccir mode always be 0
    u16RegReadVal &= ~(CHIPTOP_TO_TEST_IN_MODE_REG_MASK);
    u16RegReadVal |= ( (0 << 0) & CHIPTOP_TO_TEST_IN_MODE_REG_MASK);
    REG_WRITE(CHIPTOP_REG_BASE, CHIPTOP_TO_TEST_IN_MODE_REG_OFST, u16RegReadVal);
...
void SNR_PowerDown(int iSnrId, int iVal)
{
    ...
    {
    case 0: 
        stSnrCfg.tRegVifSnrCtl.reg_sensor00_pwrdn = iVal;
...
void SNR_Reset(int iSnrId, int iVal)
{
    ...
    {
    case 0:
        stSnrCfg.tRegVifSnrCtl.reg_sensor00_rst = iVal;
