...
#include "../drivers/mstar/gpio/mercury6p/gpio.h"
#include "../drivers/mstar/gpio/mercury6p/padmux.h"
...
static pwmPadTbl_t padTbl_0[] =
{
    ...
    { PAD_ETH_LED0, PINMUX_FOR_PWM0_MODE_2},
    { PAD_I2C3_SCL, PINMUX_FOR_PWM0_MODE_3},
};

static pwmPadTbl_t padTbl_1[] =
{
    { PAD_PWM1, PINMUX_FOR_PWM1_MODE_1},
    { PAD_ETH_LED1, PINMUX_FOR_PWM1_MODE_2},
    { PAD_I2C3_SDA, PINMUX_FOR_PWM1_MODE_3},
};
