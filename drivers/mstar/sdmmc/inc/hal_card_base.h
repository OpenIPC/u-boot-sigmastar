...
#define D_PROJECT__iNF7   13   //iNfinity7 Project
#define D_PROJECT__M6P    14   //Mercury6P Project
#define D_PROJECT__iNF6C  15   //iNfinity6c Project
...
//###########################################################################################################
#define D_PROJECT           D_PROJECT__iNF7
#define D_FCIE_M_VER        D_FCIE_M_VER__05
//###########################################################################################################
#elif defined(CONFIG_ARCH_MERCURY6P)
//###########################################################################################################
#define D_PROJECT           D_PROJECT__M6P
#define D_FCIE_M_VER        D_FCIE_M_VER__05
//###########################################################################################################
#elif defined(CONFIG_ARCH_INFINITY6C)
//###########################################################################################################
#define D_PROJECT           D_PROJECT__iNF6C
#define D_FCIE_M_VER        D_FCIE_M_VER__05
//###########################################################################################################
#else
