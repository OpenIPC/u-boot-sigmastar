...
#define HAL_DISP_IRQ_DMAMISC_DOUBLEVS_BIT  (0x0080)
#define HAL_DISP_IRQ_DMAMISC_DOUBLEVS_MSK  (0x0080)
#define HAL_DISP_IRQ_DMAMISC_OVERWRITE_BIT (0x0040)
#define HAL_DISP_IRQ_DMAMISC_OVERWRITE_MSK (0x0040)
#define HAL_DISP_IRQ_DMAMISC_ALLEMPTY_BIT  (0x0002)
#define HAL_DISP_IRQ_DMAMISC_ALLEMPTY_MSK  (0x0002)

#define HAL_DISP_IRQ_DMA_VSYNC_BIT     (0x0200) // BIT9
#define HAL_DISP_IRQ_DMA_VSYNC_MSK     (0x0200)
#define HAL_DISP_IRQ_DMA_VDE_BIT       (0x0100) // BIT8
#define HAL_DISP_IRQ_DMA_VDE_MSK       (0x0100)
#define HAL_DISP_IRQ_DMA_BLANKING_BIT  (0x0080) // BIT7
#define HAL_DISP_IRQ_DMA_BLANKING_MSK  (0x0080)
#define HAL_DISP_IRQ_DMA_TRIG_FAIL_BIT (0x0040) // BIT6
#define HAL_DISP_IRQ_DMA_TRIG_FAIL_MSK (0x0040)
#define HAL_DISP_IRQ_DMA_MISC_BIT      (0x0020) // BIT5
#define HAL_DISP_IRQ_DMA_MISC_MSK      (0x0020)
#define HAL_DISP_IRQ_DMA_LINEDONE_BIT  (0x0010) // BIT4
#define HAL_DISP_IRQ_DMA_LINEDONE_MSK  (0x0010)
#define HAL_DISP_IRQ_DMA_ACTIVE_ON_BIT (0x0008) // BIT3
#define HAL_DISP_IRQ_DMA_ACTIVE_ON_MSK (0x0008)
#define HAL_DISP_IRQ_DMA_REALDONE_BIT  (0x0004) // BIT2
#define HAL_DISP_IRQ_DMA_REALDONE_MSK  (0x0004)
...
#define HAL_DISP_CMDQIRQ_DMA_DONE_BIT      (0x0020) // BIT5
#define HAL_DISP_CMDQIRQ_DMA_DONE_MSK      (0x0020)
#define HAL_DISP_CMDQIRQ_DMA_BLANKING_BIT  (0x0010) // BIT4
#define HAL_DISP_CMDQIRQ_DMA_BLANKING_MSK  (0x0010)
#define HAL_DISP_CMDQIRQ_DMA_MISC_BIT      (0x0008) // BIT3
#define HAL_DISP_CMDQIRQ_DMA_MISC_MSK      (0x0008)
#define HAL_DISP_CMDQIRQ_DMA_LINEDONE_BIT  (0x0004) // BIT2
#define HAL_DISP_CMDQIRQ_DMA_LINEDONE_MSK  (0x0004)
#define HAL_DISP_CMDQIRQ_DMA_ACTIVE_ON_BIT (0x0002) // BIT1
#define HAL_DISP_CMDQIRQ_DMA_ACTIVE_ON_MSK (0x0002)
#define HAL_DISP_CMDQIRQ_DMA_REALDONE_BIT  (0x0001) // BIT0
#define HAL_DISP_CMDQIRQ_DMA_REALDONE_MSK  (0x0001)
...
#define HAL_DISP_MAPPING_DEVICEID_FROM_MI(x)  ((x==0) ? HAL_DISP_DEVICE_ID_1 :\
                                            (x==1) ? HAL_DISP_DEVICE_ID_0 :HAL_DISP_DEVICE_MAX)
...
#define E_HAL_DISP_IRQ_TYPE_DMA                                                                                \
    (E_HAL_DISP_IRQ_TYPE_DMA_ACTIVE_ON | E_HAL_DISP_IRQ_TYPE_DMA_REALDONE | E_HAL_DISP_IRQ_TYPE_DMA_REGSETFAIL \
     | E_HAL_DISP_IRQ_TYPE_DMA_FIFOFULL | E_HAL_DISP_IRQ_TYPE_DMA_TRIG_FAIL | E_HAL_DISP_IRQ_TYPE_DMA_MISC)
#define E_HAL_DISP_IRQ_MSK_DMA                                                                 \
    (HAL_DISP_IRQ_DMA_VSYNC_MSK | HAL_DISP_IRQ_DMA_REGFAIL_MSK | HAL_DISP_IRQ_DMA_FIFOFULL_MSK \
     | HAL_DISP_IRQ_DMA_REALDONE_MSK | HAL_DISP_IRQ_DMA_MISC_MSK | HAL_DISP_IRQ_DMA_TRIG_FAIL_MSK)
#define E_HAL_DISP_IRQ_MSK_DMA_MISC    \
    (HAL_DISP_IRQ_DMAMISC_ALLEMPTY_MSK \
     | HAL_DISP_IRQ_DMAMISC_OVERWRITE_MSK) //(HAL_DISP_IRQ_DMAMISC_ALLEMPTY_MSK|HAL_DISP_IRQ_DMAMISC_OVERWRITE_MSK|HAL_DISP_IRQ_DMAMISC_DOUBLEVS_MSK)
#define E_HAL_DISP_IRQ_MSK_WDMA_YUV_MISC (0x1 << shift_of_disp_wdma_reg_sc_frm_w_int_mask) // Y only
...
//------------------------------------------------------------------------------
// MACE
#define HAL_DISP_HPQ_BANKOFFSET_VAL       (0)
#define HAL_DISP_DEV_MACE_SUPPORT(dev)    ((dev == HAL_DISP_DEVICE_ID_0) ? 1 : 0)
#define HAL_DISP_DEV_HPQ_SUPPORT(dev)     ((dev == HAL_DISP_DEVICE_ID_1) ? 1 : 0)
#define HAL_DISP_DEV_HPQ_NEED_OFFSET(dev) (0)
...
#define HAL_DISP_GAMMA_BANKOFFSET(dev) \
    ((dev == HAL_DISP_DEVICE_ID_1) ? (REG_DISP_TOP_GAMMA1_BASE - REG_DISP_TOP_GAMMA0_BASE) : 0)
#define HAL_DISP_OP2_BANKOFFSET(dev) \
    ((dev == HAL_DISP_DEVICE_ID_1) ? (REG_DISP_TOP_OP21_BASE - REG_DISP_TOP_OP20_BASE) : 0)
...
#define HAL_DISP_REG_CRC_MD_OFF  0x0
#define HAL_DISP_REG_CRC_MD_HEAD 0x1
#define HAL_DISP_REG_CRC_MD_TAIL 0x2
#define HAL_DISP_REG_CRC_MD_RIU  0x3
...
// Patgen
//------
#define HAL_DISP_PATGEN_DEFAULT     (0xc)
//----------
// CMDQ Test
//----------
...
#define HAL_DISP_CMDQ_TEST_REG    \
        {\
            ...
            DISP_TOP0_REG_SOFTWARE_RESERVE9,\
            ...
            DISP_SGWDMA_REG_WDUMMY,\
            DISP_WDMA_REG_SC_DMA_DUMMY1,\
...
#define HAL_DISP_HDMI_VCO_MAX   (3000)
#define HAL_DISP_HDMI_VCO_MIN   (1000)
#define HAL_DISP_HDMI_VCO_RECOMMEND   (2000)
...
#define HAL_DISP_VGA_VCO_MAX   (480)
#define HAL_DISP_VGA_VCO_MIN   (192)
#define HAL_DISP_VGA_VCO_RECOMMEND   (336)
...
#define HAL_DISP_VGA_DCLKTOHWDCLKMULTIPLE (1)
#define HAL_DISP_VGA_PLLLOOPDIV 4
#define HAL_DISP_CVBS_DCLKTOHWDCLKMULTIPLE (2)
#define HAL_DISP_CVBS_PLLLOOPDIV 16
#define HAL_DISP_GET_CVBSPLLPOSTDIVVAL 32
...
#define HAL_DISP_GET_PLLLOOPDIVVAL(u32interface,u32idx) ((DISP_OUTDEV_IS_HDMI(u32interface)) ? HAL_DISP_HDMI_PLLLOOPDIV :\
                                                         (DISP_OUTDEV_IS_VGA(u32interface))   ? HAL_DISP_VGA_PLLLOOPDIV :\
