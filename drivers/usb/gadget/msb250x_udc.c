...
void msb250x_udc_allowAck(u8 cfg)
{
    ...
    switch(cfg)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            ms_writeb(ms_readb(MSB250X_OTG0_AUTONAK2_CTRL), MSB250X_OTG0_AUTONAK2_CTRL);
            ms_writeb((ms_readb(MSB250X_OTG0_AUTONAK2_CTRL) | MSB250X_OTG0_AUTONAK2_AllowAck), MSB250X_OTG0_AUTONAK2_CTRL);
            break;
    }
