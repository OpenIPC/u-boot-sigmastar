/*
* eMMC_infinity6b0_uboot.h- Sigmastar
*
...
#ifndef __eMMC_INFINITY6B0_UBOOT__
#define __eMMC_INFINITY6B0_UBOOT__
...
#define REG_BANK_FCIE0                  0x20800U //sd0:0x1410
#define REG_BANK_FCIE1                  0x20880U //sd1:0x1411
#define REG_BANK_FCIE2                  0x20900U //sd2:0x1412
#else
...
#if 1 // Independent CHIPTOP & PADTOP
#define PAD_CHIPTOP_REG                 GET_REG_ADDR(RIU_BASE, REG_BANK_CHIPTOP) //CHIPTOP OR PADTOP
#define PAD_PADTOP_REG                  GET_REG_ADDR(RIU_BASE, REG_BANK_PADTOP) //CHIPTOP OR PADTOP
#endif
...
#define reg_all_pad_in                  GET_REG_ADDR(PAD_CHIPTOP_REG, 0x50)
#define BIT_ALL_PAD_IN                  (BIT15)

#define reg_sd_config                   GET_REG_ADDR(PAD_CHIPTOP_REG, 0x08)
...
#define eMMC_die(msg) printf(msg);
...
#endif /* __eMMC_INFINITY6B0_UBOOT__ */
