...
#define  STANDARD_KEYPADNUM_1        (7)
#define  STANDARD_KEYPADNUM_2        (4)
...
typedef enum
{
    ...
    E_KP_STANDARD_MODE1 = 1,
    /* mode0 -> keypad standard 4*4  */
    E_KP_STANDARD_MODE2 = 2,
    /* mode0 -> keypad standard 3*3  */
    E_KP_STANDARD_MODE3 = 3,
}KEYPAD_STANDARD;
...
struct ms_keypad_date {
    ...
    struct ms_keypad_rulenum rulenum[1];
};
...
#define REG_KEYPAD_CLK_BANK_BASE         0x103800UL

//#define KEYPAD_RIU_BASE                  0xFD000000UL
#define KEYPAD_RIU_BASE                  0x1F000000UL
...
#define KEYPAD_CLK_WRITE(addr,val)          (REG16(REG_KEYPAD_CLK_BANK_BASE,  addr)=(val))
#define KEYPAD_CLK_READ(addr)               (REG16(REG_KEYPAD_CLK_BANK_BASE, addr))
...
#define KEYPAD_KEY_NUM                              (0x00)
    #define KEYPAD_COL                              (BIT0|BIT1|BIT2|BIT3)
    #define KEYPAD_ROW                              (BIT4|BIT5|BIT6|BIT7)
