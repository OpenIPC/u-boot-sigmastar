...
typedef struct
{
    HalDispPictureIfNonLinearCurveType_t stDispDevice[E_HAL_DISP_PICTURE_NUM];
...
INTERFACE void HalDispPictureIfSetConfig(HalDispCscmatrix_e eCscMatrix, HalDispPictureConfig_t *pstPictureCfg,
                                         void *pCtx);
INTERFACE u8   HalDispPictureIfTransNonLinear(void *pCtx, HalDispCsc_t *pstCsc, u32 *pu32Sharpness,
                                              HalDispPictureConfig_t *pstPictureCfg);
INTERFACE void HalDispPictureIfSetPqConfig(u32 u32DevId, HalDispPicturePqConfig_t *pstPqInCfg);
INTERFACE u8   HalDispPictureIfIsPqUpdate(u32 u32DevId);
INTERFACE void HalDispPictureIfApplyPqConfig(void *pCtx);
