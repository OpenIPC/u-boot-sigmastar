...
// Chip reboot type
#define MS_REBOOT_BY_WDT_RST 1
#define MS_REBOOT_BY_SW_RST  2
#define MS_REBOOT_BY_HW_RST  3
...
#define REG_ADDR_BASE_PMPOR                 GET_BASE_ADDR_BY_BANK( MS_BASE_REG_RIU_PA, 0x000600 )
