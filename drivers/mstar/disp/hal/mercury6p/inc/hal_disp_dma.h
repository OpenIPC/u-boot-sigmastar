...
#define HAL_DISP_DMA_FRM_W_444_Y_G_LOC_SHIFT (shift_of_disp_wdma_reg_sc_frm_w_444_y_location)
#define HAL_DISP_DMA_FRM_W_444_U_B_LOC_SHIFT (shift_of_disp_wdma_reg_sc_frm_w_444_u_location)
#define HAL_DISP_DMA_FRM_W_444_V_R_LOC_SHIFT (shift_of_disp_wdma_reg_sc_frm_w_444_v_location)
...
INTERFACE void HalDispDmaSetFrmWRingBuffHeight(u16 *pu16Height, void *pCtx);
INTERFACE void HalDispDmaSetFrmWEnByFormat(u8 *pbEn, void *pCtx);
INTERFACE void HalDispDmaSetFrmWFifoSizeByFormat(u8 *p8Size, void *pCtx);
INTERFACE void HalDispDmaSetFrmWFifoStartByFormat(u8 *p8Size, void *pCtx);
INTERFACE void HalDispDmaSetFrmWWidthByFormat(u16 *p16Pixel, void *pCtx);
INTERFACE void HalDispDmaSetFrmWHeightByFormat(u16 *p16Pixel, void *pCtx);
INTERFACE void HalDispDmaSetFrmWPixelByFormat(u16 *p16Pixel, void *pCtx);
INTERFACE void HalDispDmaSetFrmWPitchByFormat(u16 *p16Pixel, void *pCtx);
INTERFACE void HalDispDmaSetRingDbfEn(u8 bEn, void *pCtx);
...
INTERFACE void HalDispDmaSetFrmWCompessEn(u16 u16Val, void *pCtx);
...
INTERFACE void HalDispDmaSetFrmWCrc16(u8 *pbEn, HalDispCrc16Type_e enCrcTpye, void *pCtx);
INTERFACE void HalDispDmaGetFrmWCrc16(u32 *p32Val);
...
INTERFACE void HalDispDmaSetCvbsRingEn(u16 u16Val, u8 *pbEn, void *pCtx);
