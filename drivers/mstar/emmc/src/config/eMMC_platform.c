...
U32 eMMC_CheckIfMemCorrupt(void)
{
    ...
    return eMMC_ST_SUCCESS;
      ...
      (defined(eMMC_DRV_INFINITY7_UBOOT)&&eMMC_DRV_INFINITY7_UBOOT) || \
      (defined(eMMC_DRV_MERCURY6P_UBOOT)&&eMMC_DRV_MERCURY6P_UBOOT) || \
      (defined(eMMC_DRV_INFINITY6C_UBOOT)&&eMMC_DRV_INFINITY6C_UBOOT)
...
#if (defined(eMMC_DRV_INFINITY7_UBOOT)&&eMMC_DRV_INFINITY7_UBOOT)
static void eMMC_InitPadPin(void)
{
#if CONFIG_SELECT_EMMC3
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4F)) = 0x09D5;   // PAD_EMMC_D0
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x50)) = 0x09D5;   // PAD_EMMC_D1
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x51)) = 0x09D5;   // PAD_EMMC_D2
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x52)) = 0x09D5;   // PAD_EMMC_D3

#if (FCIE_eMMC_SDR == FCIE_MODE_8BITS_MACRO_HIGH_SPEED)         // eMMC 8bit mode
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x53)) = 0x09D5;   // PAD_EMMC_D4
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x54)) = 0x09D5;   // PAD_EMMC_D5
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x55)) = 0x09D5;   // PAD_EMMC_D6
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x56)) = 0x09D5;   // PAD_EMMC_D7
#endif

    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x57)) = 0x09E5;   // PAD_EMMC_CLK
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x58)) = 0x09D5;   // PAD_EMMC_CMD
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x59)) = 0x09D5;   // PAD_EMMC_RST
#elif CONFIG_SELECT_EMMC2
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x29)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x2A)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x2B)) = 0xFE4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x2C)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x2D)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x2E)) = 0xFD4;
#elif CONFIG_SELECT_EMMC1
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x48)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x49)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4A)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4B)) = 0xFE4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4C)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4D)) = 0xFD4;
    REG_FCIE(GET_REG_ADDR(PAD_PADGPIO2_BASE, 0x4E)) = 0xFD4;
#else
    REG_FCIE_CLRBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x29), 0x7F);
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x2B), 0x5F);

    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x23), 0x1ff);
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x24), 0x1ff);
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x25), 0x1ff);
    REG_FCIE_SETBIT(GET_REG_ADDR(A_SDPLL_BANK, 0x26), 0x1ff);
#endif
}
#endif
...
U32 eMMC_pads_switch(U32 u32Mode)
{
...
#elif (defined(eMMC_DRV_INFINITY7_UBOOT)&&eMMC_DRV_INFINITY7_UBOOT)
#if (FCIE_eMMC_SDR == FCIE_MODE_8BITS_MACRO_HIGH_SPEED)
    if( u32Mode == FCIE_MODE_8BITS_MACRO_HIGH_SPEED || FCIE_eMMC_BYPASS_8X == u32Mode)
    {
        REG_FCIE_CLRBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x60), BIT7|BIT8|BIT9);  //clear ej_mode
        REG_FCIE_SETBIT(reg_emmc_config, (BIT_EMMC_MODE_8X)); //8B mode
...
#elif (defined(eMMC_DRV_MERCURY6P_UBOOT)&&eMMC_DRV_MERCURY6P_UBOOT)
        if( u32Mode == FCIE_MODE_8BITS_MACRO_HIGH_SPEED || FCIE_eMMC_BYPASS_8X == u32Mode)
        {
            //REG_FCIE_CLRBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x60), BIT7|BIT8|BIT9);  //clear ej_mode
            REG_FCIE_SETBIT(reg_emmc_config, (BIT_EMMC_MODE_8X)); //8B mode
...
#elif (defined(eMMC_DRV_INFINITY6C_UBOOT)&&eMMC_DRV_INFINITY6C_UBOOT)
            /*if( u32Mode == FCIE_MODE_8BITS_MACRO_HIGH_SPEED || FCIE_eMMC_BYPASS_8X == u32Mode)
            {
                //REG_FCIE_CLRBIT(GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x60), BIT7|BIT8|BIT9);  //clear ej_mode
                REG_FCIE_SETBIT(reg_emmc_config, (BIT_EMMC_MODE_8X)); //8B mode
    ...
    {
        REG_FCIE_SETBIT(FCIE_DDR_MODE, BIT_PAD_IN_SDR);
    }
