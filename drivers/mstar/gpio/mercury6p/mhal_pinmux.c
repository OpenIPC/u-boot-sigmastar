...
#include "asm/arch-mercury6p/mach/ms_types.h"
#else
...
#define _GPIO_W_WORD_MASK(addr, val, mask)                                                    \
    {                                                                                         \
        (*(volatile u16*)(unsigned long)(addr)) =                                        \
            ((*(volatile u16*)(unsigned long)(addr)) & ~(mask)) | ((u16)(val) & (mask)); \
    }
#define _GPIO_R_BYTE(addr)            (*(volatile u8*)(unsigned long)(addr))
#define _GPIO_R_WORD_MASK(addr, mask) ((*(volatile u16*)(unsigned long)(addr)) & (mask))
...
#define REG_SAR_GPIO0_GPIO_MODE         0x0B
#define REG_SAR_GPIO0_GPIO_MODE_MASK    BIT0
#define REG_SAR_GPIO1_GPIO_MODE         0x0B
#define REG_SAR_GPIO1_GPIO_MODE_MASK    BIT1
#define REG_SAR_GPIO2_GPIO_MODE         0x0B
#define REG_SAR_GPIO2_GPIO_MODE_MASK    BIT2
#define REG_SAR_GPIO3_GPIO_MODE         0x0B
...
const ST_PadMuxInfo spi_wpz_tbl[] = {
    ...
    {PAD_SPI_WPZ, PADTOP_BANK, REG_SPI_WPZ_EXT_EN_MODE, REG_SPI_WPZ_EXT_EN_MODE_MASK, BIT0, PINMUX_FOR_GPIO_MODE},
...
const ST_PadMuxInfo spi_do_tbl[] = {
    ...
    {PAD_SPI_DO, PADTOP_BANK, REG_SPI_DO_EXT_EN_MODE, REG_SPI_DO_EXT_EN_MODE_MASK, BIT1, PINMUX_FOR_GPIO_MODE},
...
const ST_PadMuxInfo spi_cz_tbl[] = {
    ...
    {PAD_SPI_CZ, PADTOP_BANK, REG_SPI_CZ_EXT_EN_MODE, REG_SPI_CZ_EXT_EN_MODE_MASK, BIT2, PINMUX_FOR_GPIO_MODE},
...
const ST_PadMuxInfo spi_hld_tbl[] = {
    ...
    {PAD_SPI_HLD, PADTOP_BANK, REG_SPI_HLD_EXT_EN_MODE, REG_SPI_HLD_EXT_EN_MODE_MASK, BIT3, PINMUX_FOR_GPIO_MODE},
...
const ST_PadMuxInfo spi_ck_tbl[] = {
    ...
    {PAD_SPI_CK, PADTOP_BANK, REG_SPI_CK_EXT_EN_MODE, REG_SPI_CK_EXT_EN_MODE_MASK, BIT4, PINMUX_FOR_GPIO_MODE},
...
const ST_PadMuxInfo spi_di_tbl[] = {
    ...
    {PAD_SPI_DI, PADTOP_BANK, REG_SPI_DI_EXT_EN_MODE, REG_SPI_DI_EXT_EN_MODE_MASK, BIT5, PINMUX_FOR_GPIO_MODE},
...
U8 HalPadModeToVal(U8* pu8Mode, U8* u8Index)
{
    ...
    {
        if (!strcmp((const char *)m_stPadModeInfoTbl[index].u8PadName, (char *)pu8Mode))
        {
            *u8Index = index;
            return 0;
        }
