...
#define A_FCIE3_0_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0B00)      //SDIO0_0_BANK 1413h
#define A_FCIE3_1_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0B80)      //SDIO0_1_BANK 1414h
#define A_FCIE3_2_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0C00)      //SDIO0_2_BANK 1415h

#define A_FCIE4_0_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0D00)      //SDIO0_0_BANK 1410h
#define A_FCIE4_1_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0D80)      //SDIO0_1_BANK 1411h
#define A_FCIE4_2_BANK      GET_CARD_REG_ADDR(A_RIU_BASE, 0xA0E00)      //SDIO0_2_BANK 1412h
