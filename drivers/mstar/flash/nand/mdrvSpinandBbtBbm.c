...
static u8 _MDRV_BBT_get_part(u32 *u32_offset, u32 *u32_size)
{
    ...
    MDRV_PARTS_get_active_part((u8 *)"CIS", &st_partInfo);
    *u32_offset = st_partInfo.u32_Offset;
    *u32_size   = st_partInfo.u32_Size;
...
u8 MDRV_BBT_init(u8 *bbt_buf)
{
    ...
    for (; u32_end > (u32_page * FLASH_BBT_PAGE_SIZE); u32_page += FLASH_BBT_PAGES_PER_BLOCK)
    {
