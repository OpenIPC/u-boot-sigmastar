...
void HalDispSetBaseAddr(u32 u32YBase, u32 u32CBase, u16 u16FrameIdx)
{
    ...
    #if 0
    if(u32YBase < MIU1_BASE)
            W2BYTEMSK(REG_SCL_DMA2_01_L, 0, BIT12);
        else {
            W2BYTEMSK(REG_SCL_DMA2_01_L, 1<<12, BIT12);
            u32YBase -= MIU1_BASE;
            u32CBase -= MIU1_BASE;
        }
   #endif
...
{
    W2BYTEMSK(REG_SCL_DMA0_60_L, (u16BaseNum-1)<<3, BIT5|BIT4|BIT3);
}

void HalDispSetOutPutOnOff(bool bEn)
{
    #if 0
    W2BYTEMSK(REG_SCL_DMA0_30_L, 8<<8, 0xFF00);
    W2BYTEMSK(REG_SCL_DMA0_31_L, 0xFF<<8, 0xFF00);
    W2BYTEMSK(REG_SCL_DMA0_31_L, 0xF8, 0x00FF);
    W2BYTEMSK(REG_SCL3_1F_L, 0x21, 0x00FF);
    W2BYTEMSK(REG_SCL3_1F_L, 0xFF<<8, 0xFF00);
    #endif
...
void HalDispSetColorFormat(HalDispPixelFormat_e enPixeFmt)
{
    ...
    W2BYTEMSK(REG_SCL_DMA0_02_L, bYuv422 ? BIT14 : 0 , BIT14);
