...
#define GPIO31_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO32_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO33_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO34_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO35_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO36_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO37_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO38_DRV  0x141A8A, BIT0 | BIT1 | BIT2
...
#define GPIO39_DRV  0x141A8A, BIT4 | BIT5 | BIT6
...
#define GPIO40_DRV  0x141A8A, BIT4 | BIT5 | BIT6
...
#define GPIO41_DRV  0x141A8A, BIT8 | BIT9 | BIT10
...
#define GPIO42_DRV  0x141A8A, BIT8 | BIT9 | BIT10
...
U8 MHal_GPIO_Drv_Set(U8 u8IndexGPIO, U8 u8Level)
{
    ...
    {
        for (i = 0; i < GpioList[u8IndexGPIO - PAD_SD0_GPIO0].size; i++)
        {
            Level_Bit = GpioList[u8IndexGPIO - PAD_SD0_GPIO0].gpio[i].mask;
            Pad_Bit   = GpioList[u8IndexGPIO - PAD_SD0_GPIO0].gpio[i].val;
            Addr_sd   = GpioList[u8IndexGPIO - PAD_SD0_GPIO0].gpio[i].offset
                      + GpioList[u8IndexGPIO - PAD_SD0_GPIO0].gpio[i].base;
