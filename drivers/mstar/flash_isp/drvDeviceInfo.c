...
hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
 ...
 //not support   { FLASH_IC_BYT_BY25Q128AS,  MID_25Q,     0X40,  0X18,   _pstWriteProtectTable_BY25Q128AS_CMP0,  NULL,               0x1000000,  256,    SIZE_64KB,  256,    50,    BITS(6:2, 0x0F),    ISP_DEV_PMC,        ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_FAST_MODE   }, TRUE,   TRUE},
    ...
    { FLASH_IC_XM25QH64B,	MID_XM,	    0x60,	0x17,	NULL,                                 NULL,                       0x800000,   128,	  SIZE_64KB,  256,	  50,	 BITS(5:2, 0x0F),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
    { FLASH_IC_XM25QH128C,	MID_XM,	    0x40,	0x18,	NULL,                                 NULL,                       0x1000000,  256,	  SIZE_64KB,  256,	  50,	 BITS(4:2, 0x07),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
	{ FLASH_IC_XM25QH64C,	MID_XM,	    0x40,	0x17,	NULL,                                 NULL,                       0x800000,   128,	  SIZE_64KB,  256,	  50,	 BITS(4:2, 0x07),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
	{ FLASH_IC_XM25QH256C,	MID_XM,	    0x40,	0x19,	NULL,                                 NULL,                       0x2000000,   128,	  SIZE_64KB,  256,	  50,	 BITS(4:2, 0x07),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
    ...
    { FLASH_IC_ZB25Q128,    MID_ZB,     0X40,   0X18,   NULL,                                 NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,    BITS(5:2, 0x0F),    ISP_DEV_PMC,        ISP_SPI_ENDIAN_LITTLE, {E_SPI_54M  , E_DUAL_AD_MODE},  TRUE,   TRUE},	{ FLASH_IC_XM25QH128C,	MID_XM,	    0x40,	0x18,	_pstWriteProtectTable_XM25QH128C,     NULL,                       0x1000000,  256,	  SIZE_64KB,  256,	  133,	 BITS(6:2, 0x1F),	 ISP_DEV_NEXTFLASH,	 ISP_SPI_ENDIAN_LITTLE, {E_SPI_86M  , E_QUAD_MODE}, TRUE,   TRUE},
	{ FLASH_IC_NM25Q64,     MID_NM,     0X22,   0X17,   NULL,                                 NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,    BITS(6:2, 0x0F),    ISP_DEV_PMC,        ISP_SPI_ENDIAN_LITTLE, {E_SPI_54M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
    { FLASH_IC_NM25Q128,    MID_NM,     0X21,   0X18,   NULL,                                 NULL,                       0x1000000,  256,    SIZE_64KB,  256,    50,    BITS(6:2, 0x0F),    ISP_DEV_PMC,        ISP_SPI_ENDIAN_LITTLE, {E_SPI_54M  , E_DUAL_AD_MODE}, TRUE,   TRUE},
