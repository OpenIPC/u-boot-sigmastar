/*
* snr_cfg_infinity6b0.h- Sigmastar
*
...
typedef struct
{
    ...
    union
    {
        struct
        {
            u16 reg_sensor00_rst                      :1;
            u16 reg_sensor00_pwrdn                    :1;
            u16 reg_sensor01_rst                      :1;
            u16 reg_sensor01_pwrdn                    :1;
            u16 reg_sensor1_rst                       :1;
            u16 reg_sensor1_pwrdn                     :3;
        } tRegVifSnrCtl;
        u16 nRegVifSnrCtl;
    };
} tSensorConfig;
