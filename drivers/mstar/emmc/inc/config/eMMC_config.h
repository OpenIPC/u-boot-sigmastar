...
#elif defined(CONFIG_ARCH_INFINITY7)
#define ENABLE_INFINITY7        1
#elif defined(CONFIG_ARCH_MERCURY6P)
#define ENABLE_MERCURY6P        1
#elif defined(CONFIG_ARCH_INFINITY6C)
#define ENABLE_INFINITY6C       1
#endif
...
#elif ENABLE_INFINITY7
#define eMMC_DRV_INFINITY7_UBOOT        1
#elif ENABLE_MERCURY6P
#define eMMC_DRV_MERCURY6P_UBOOT        1
#elif ENABLE_INFINITY6C
#define eMMC_DRV_INFINITY6C_UBOOT        1
#endif
