...
#endif
#define _BITS(_bits_, _val_) ((_BIT(((1)?_bits_)+1)-_BIT(((0)?_bits_))) & (_val_<<((0)?_bits_)))
#define _BITMASK(_bits_)     (_BIT(((1)?_bits_)+1)-_BIT(((0)?_bits_)))
...
#define DSI_REG_BASE_2      (0x1A2900UL<<1)
#define DSI_CMDQ_BASE       (0x1A2A00UL)
#define DSI_CMDQ_BASE_2     (0x1A2A00UL<<1)

//-----------------------------------------------------------------------------------------------

#define REG_DSI_START    0x0000         //DSI Start Register
     #define DSI_VM_CMD_START           _BIT16
     #define DSI_SKEWCAL_START          _BIT4
     #define DSI_SLEEPOUT_START         _BIT2
     #define DSI_DSI_START              _BIT0
...
#define REG_DSI_STATUS    0x0004        //DSI Status Register
    #define DSI_CONTENTION_ERR          _BIT7
     #define DSI_FALSE_CTRL_ERR         _BIT6
     #define DSI_ESC_SYNC_ERR           _BIT5
     #define DSI_ESC_ENTRY_ERR          _BIT4
     #define DSI_BUFFER_UNDERRUN        _BIT1
     //Contention error
...
#define REG_DSI_INTEN    0x0008             //DSI Interrupt Enable Register
    #define DSI_SKEWCAL_DONE_INT_EN         _BIT11
     #define DSI_VM_VFP_STR_INT_EN          _BIT10
     #define DSI_VM_VACT_STR_INT_EN         _BIT9
     #define DSI_VM_VBP_STR_INT_EN          _BIT8
     #define DSI_TE_TIMEOUT_INT_EN          _BIT7
     #define DSI_SLEEPOUT_DONE_INT_EN       _BIT6
     #define DSI_VM_CMD_DONE_INT_EN         _BIT5
     #define DSI_FRAME_DONE_INT_EN          _BIT4
     #define DSI_VM_DONE_INT_EN             _BIT3
     #define DSI_TE_RDY_INT_EN              _BIT2
     #define DSI_CMD_DONE_INT_EN            _BIT1
     #define DSI_LPRX_RD_RDY_INT_EN         _BIT0
...
#define REG_DSI_INTSTA    0x000C            //DSI Interrupt Status Register
    #define DSI_DSI_BUSY                    _BIT31
    #define DSI_SKEWCAL_DONE_INT_FLAG       _BIT11
    #define DSI_VM_VFP_STR_INT_FLAGN        _BIT10
    #define DSI_VM_VACT_STR_INT_FLAG        _BIT9
    #define DSI_VM_VBP_STR_INT_FLAG         _BIT8
    #define DSI_TE_TIMEOUT_INT_FLAG         _BIT7
    #define DSI_SLEEPOUT_DONE_INT_FLAG      _BIT6
    #define DSI_VM_CMD_DONE_INT_FLAG        _BIT5
    #define DSI_FRAME_DONE_INT_FLAG         _BIT4
    #define DSI_VM_DONE_INT_FLAG            _BIT3
    #define DSI_TE_RDY_INT_FLAG             _BIT2
    #define DSI_CMD_DONE_INT_FLAG           _BIT1
    #define DSI_LPRX_RD_RDY_INT_FLAG        _BIT0
...
#define REG_DSI_COM_CON     0x0010  //DSI Common Control Register
    #define DSI_DSI_DUAL_EN         _BIT4
    #define DSI_DPHY_RESET          _BIT2
    #define DSI_DSI_RESET           _BIT0
...
#define REG_DSI_MODE_CON 0x0014                 //DSI Mode Control Register
    #define DSI_SLEEP_MODE                      _BIT20
     #define DSI_C2V_SWITCH_ON                  _BIT19
     #define DSI_V2C_SWITCH_ON                  _BIT18
     #define DSI_MIX_MODE                       _BIT17
     #define DSI_FRAME_MODE                     _BIT16
     #define DSI_MODE_CON_CMD                   _BITS(1:0,0)
     #define DSI_MODE_CON_VID_SYNC_PULSE        _BITS(1:0,1)
     #define DSI_MODE_CON_VID_SYNC_EVENT        _BITS(1:0,2)
     #define DSI_MODE_CON_BURST                 _BITS(1:0,3)
     #define DSI_MODE_MASK                      _BITMASK(1:0)
...
#define REG_DSI_TXRX_CON 0x0018             //DSI TX RX Control Register
    #define DSI_RGB_PKT_CNT                 _BITMASK(27:24)
     #define DSI_EXT_TE_TIME_VM             _BITMASK(23:20)
     #define DSI_TE_TIMEOUT_CHK_EN          _BIT19
     #define DSI_TE_WITH_CMD_EN             _BIT18
     #define DSI_TYPE1_BTA_SEL              _BIT17
     #define DSI_HSTX_CKLP_EN               _BIT16
     #define DSI_MAX_RTN_SIZE               _BITMASK(15:12)
     #define DSI_TE_AUTO_SYNC               _BIT11
     #define DSI_EXT_TE_EDGE_SEL            _BIT10
     #define DSI_EXT_TE_EN                  _BIT9
     #define DSI_TE_FREERUN                 _BIT8
     #define DSI_HSTX_BLLP_EN               _BIT7
     #define DSI_HSTX_DIS_EOT               _BIT6
     #define DSI_LANE_NUM                   _BITMASK(5:2)
     #define DSI_VC_NUM                     _BITMASK(1:0)
...
#define REG_DSI_PSCON 0x001C            //DSI Pixel Stream Control Register
    #define DSI_BYTE_SWAP               _BIT25
     #define DSI_RGB_SWAP               _BIT24
     #define DSI_DSI_PS_SEL             _BITMASK(17:16)
     #define DSI_TDSI_PS_WC             _BITMASK(13:0)
...
#define REG_DSI_LFR_CON 0x0030          //DSI Low Frame Rate Control Register
    #define DSI_LFR_SKIP_NUM            _BITMASK(13:8)
    #define DSI_LFR_VSE_DIS             _BIT6
    #define DSI_LFR_UPDATE              _BIT5
    #define DSI_LFR_EN                  _BIT4
    #define DSI_LFR_TYPE                _BITMASK(3:2)
    #define DSI_LFR_MODE                _BITMASK(1:0)
...
#define REG_DSI_LFR_STA 0x0034          //DSI Low Frame Rate Status Register
    #define DSI_LFR_SKIP_STA            _BIT8
    #define DSI_LFR_SKIP_CNT            _BITMASK(5:0)
...
#define REG_DSI_HSA_WC 0x0050       //DSI Horizontal Sync Active Word Count Register
    #define DSI_HSA_WC              _BITMASK(11:0)
...
#define REG_DSI_HBP_WC 0x0054       //DSI Horizontal Back Porch Word Count Register
    #define DSI_HBP_WC              _BITMASK(11:0)
...
#define REG_DSI_HFP_WC 0x0058        //DSI Horizontal Front Porch Word Count Register
    #define DSI_HFP_WC               _BITMASK(11:0)
...
#define REG_DSI_BLLP_WC 0x005C      //DSI Horizontal Blanking or Low Power Mode Word Count Register
    #define DSI_BLLP_WC             _BITMASK(11:0)
...
#define REG_DSI_HSTX_CKLP_WC_AUTO_RESULT    0x0068  //DSI HSTX Clock Low-power Mode Automatic Calculation result
    #define DSI_HSTX_CKLP_WC_AUTO_RESULT            _BITMASK(15:0)
...
#define REG_DSI_RX_DATA03    0x0074     //DSI Receive Packet Data Byte 0 ~ 3 Register
    #define DSI_RX_BYTE3                _BITMASK(31:24)
    #define DSI_RX_BYTE2                _BITMASK(23:16)
    #define DSI_RX_BYTE1                _BITMASK(15:8)
    #define DSI_RX_BYTE0                _BITMASK(7:0)

#define REG_DSI_RX_DATA47    0x0078     //DSI Receive Packet Data Byte 4 ~ 7 Register
    #define DSI_RX_BYTE7                _BITMASK(31:24)
    #define DSI_RX_BYTE6                _BITMASK(23:16)
    #define DSI_RX_BYTE5                _BITMASK(15:8)
    #define DSI_RX_BYTE4                _BITMASK(7:0)

#define REG_DSI_RX_DATA8B    0x007C     //DSI Receive Packet Data Byte 8 ~ 11 Register
    #define DSI_RX_BYTEB                _BITMASK(31:24)
    #define DSI_RX_BYTEA                _BITMASK(23:16)
    #define DSI_RX_BYTE9                _BITMASK(15:8)
    #define DSI_RX_BYTE8                _BITMASK(7:0)

#define REG_DSI_RX_DATAC    0x0080      //DSI Receive Packet Data Byte 12 ~ 15 Register
    #define DSI_RX_BYTEF                _BITMASK(31:24)
    #define DSI_RX_BYTEE                _BITMASK(23:16)
    #define DSI_RX_BYTED                _BITMASK(15:8)
    #define DSI_RX_BYTEC                _BITMASK(7:0)

#define REG_DSI_RX_RACK    0x0084       //DSI Read Data Acknowledge Register
    #define DSI_RACK_BYPASS             _BIT1
    #define DSI_RACK                    _BIT0
...
#define REG_DSI_RX_TRIG_STA    0x0088       //DSI Receiver Status Register
    #define DSI_RX_POINTER                  _BITMASK(11:8)
    #define DSI_RX_LPDT                     _BIT6
    #define DSI_DIRECTION                   _BIT5
    #define DSI_RX_ULPS                     _BIT4
    #define DSI_RX_TRIG_3                   _BIT3
    #define DSI_RX_TRIG_2                   _BIT2
    #define DSI_RX_TRIG_1                   _BIT1
    #define DSI_RX_TRIG_0                   _BIT0
...
#define REG_DSI_TIME_CON0    0x00A0     //DSI Timing Control 0 Register
    #define DSI_SKEWCAL_PRD             _BITMASK(31:16)
    #define DSI_ULPS_WAKEUP_PRD         _BITMASK(15:0)
...
#define REG_DSI_TIME_CON1    0x00A4         //DSI Timing Control 1 Register
    #define DSI_PREFETCH_EN                 _BIT31
    #define DSI_PREFETCH_TIME               _BITMASK(30:16)
    #define DSI_TE_TIMEOUT_PRD              _BITMASK(15:0)
...
#define REG_DSI_PHY_LCPAT    0x0100         //DSI PHY Lane Clock Pattern Register
    #define DSI_LC_HSTX_CK_PAT              _BITMASK(7:0)
...
#define REG_DSI_PHY_LCCON    0x0104         //DSI PHY Lane Clock Control Register
    #define DSI_LC_WAKEUP_EN                _BIT2
    #define DSI_LC_ULPM_EN                  _BIT1
    #define DSI_LC_HSTX_EN                  _BIT0
...
#define REG_DSI_PHY_LD0CON    0x0108    //DSI PHY Lane 0 Control Register
    #define DSI_L0_RX_FILTER_EN         _BIT4
    #define DSI_LX_ULPM_AS_L0           _BIT3
    #define DSI_L0_WAKEUP_EN            _BIT2
    #define DSI_L0_ULPM_EN              _BIT1
    #define DSI_L0_RM_TRIG_EN           _BIT0
...
#define REG_DSI_PHY_SYNCON    0x010C            //DSI PHY Sync Control Register
    #define DSI_HS_DB_SYNC_EN                   _BIT24
    #define DSI_HS_SKEWCAL_PAT                  _BITMASK(23:16)
    #define DSI_HS_SYNC_CODE2                   _BITMASK(15:8)
    #define DSI_HS_SYNC_CODE                    _BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON0    0x0110       //DSI PHY Timing Control 0 Register
    #define DSI_DA_HS_TRAIL                 _BITMASK(31:24)
    #define DSI_DA_HS_ZERO                  _BITMASK(23:16)
    #define DSI_DA_HS_PREP                  _BITMASK(15:8)
    #define DSI_LPX                         _BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON1    0x0114       //DSI PHY Timing Control 1 Register
    #define DSI_DA_HS_EXIT                  _BITMASK(31:24)
    #define DSI_TA_GET                      _BITMASK(23:16)
    #define DSI_TA_SURE                     _BITMASK(15:8)
    #define DSI_TA_GO                       _BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON2    0x0118       //DSI PHY Timing Control 2 Register
    #define DSI_CLK_HS_TRAIL                _BITMASK(31:24)
    #define DSI_CLK_HS_ZERO                 _BITMASK(23:16)
    #define DSI_DA_HS_SYNC                  _BITMASK(15:8)
    #define DSI_CONT_DET                    _BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON3    0x011C    //DSI PHY Timing Control 3 Register
    #define DSI_CLK_HS_EXIT                _BITMASK(23:16)
    #define DSI_CLK_HS_POST                _BITMASK(15:8)
    #define DSI_CLK_HS_PREP                _BITMASK(7:0)
...
#define REG_DSI_VM_CMD_CON    0x0130    //DSI Video Mode Command Packet Control Register
    #define DSI_CM_DATA_1               _BITMASK(31:24)
    #define DSI_CM_DATA_0               _BITMASK(23:16)
    #define DSI_CM_DATA_ID              _BITMASK(15:8)
    #define DSI_TS_VFP_EN               _BIT5
    #define DSI_TS_VBP_EN               _BIT4
    #define DSI_TS_VSA_EN               _BIT3
    #define DSI_TIME_SEL                _BIT2
    #define DSI_LONG_PKT                _BIT1
    #define DSI_VM_CMD_EN               _BIT0
...
#define REG_DSI_VM_CMD_DATA0    0x0134      //DSI Video Mode Command Packet Data Byte 0~3 Register
    #define DSI_LONG_PKT_WORD03             _BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATA4    0x0138      //DSI Video Mode Command Packet Data Byte 4~7 Register
    #define DSI_LONG_PKT_WORD47             _BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATA8    0x013C      //DSI Video Mode Command Packet Data Byte 8~11 Register
    #define DSI_LONG_PKT_WORD8B             _BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATAC    0x0140      //DSI Video Mode Command Packet Data Byte 12~15 Register
    #define DSI_LONG_PKT_WORDCF             _BITMASK(31:0)
...
#define REG_DSI_CKSM_OUT    0x0144          //DSI Checksum Output
    #define DSI_ACC_CHKSUM                  _BITMASK(31:16)
    #define DSI_PKT_CHKSUM                  _BITMASK(15:0)
...
#define REG_DSI_STATE_DBG0    0x0148        //DSI State Machine Debug 0
    #define DSI_DPHY_HS_TX_STATE_C          _BITMASK(20:16)
    #define DSI_DPHY_CTL_STATE_C            _BITMASK(8:0)
...
#define REG_DSI_STATE_DBG1    0x014C        //DSI State Machine Debug 1
    #define DSI_DPHY_ESC_STATE_0            _BITMASK(31:24)
    #define DSI_DPHY_HS_TX_STATE_0          _BITMASK(20:16)
    #define DSI_DPHY_CTL_STATE_0            _BITMASK(14:0)
...
#define REG_DSI_STATE_DBG2    0x0150            //DSI State Machine Debug 2
    #define DSI_DPHY_TA_R2T_STATE               _BITMASK(28:24)
    #define DSI_DPHY_TA_T2R_STATE               _BITMASK(20:16)
    #define DSI_DPHY_RX_ESC_STATE               _BITMASK(9:0)
...
#define REG_DSI_STATE_DBG3    0x0154             //DSI State Machine Debug 3
    #define DSI_DPHY_HS_TX_STATE_2               _BITMASK(28:24)
    #define DSI_DPHY_CTL_STATE_2                 _BITMASK(20:16)
    #define DSI_DPHY_HS_TX_STATE_1               _BITMASK(12:8)
    #define DSI_DPHY_CTL_STATE_1                 _BITMASK(4:0)
...
#define REG_DSI_STATE_DBG4    0x0158            //DSI State Machine Debug 4
    #define DSI_DPHY_HS_TX_STATE_3               _BITMASK(12:8)
    #define DSI_DPHY_CTL_STATE_3                 _BITMASK(4:0)
...
#define REG_DSI_STATE_DBG5    0x015C            //DSI State Machine Debug 5
    #define DSI_WAKEUP_STATE                    _BITMASK(31:28)
    #define DSI_TIMER_BUSY                      _BIT16
    #define DSI_TIMER_COUNTER                   _BITMASK(15:0)
...
#define REG_DSI_STATE_DBG6    0x0160            //DSI State Machine Debug 6
    #define DSI_CMDQ_STATE                      _BITMASK(22:16)
    #define DSI_CMCTL_STATE                     _BITMASK(14:0)
...
#define REG_DSI_STATE_DBG7    0x0164            //DSI State Machine Debug 7
    #define DSI_VSA_PERIOD                      _BIT15
    #define DSI_VBP_PERIOD                      _BIT14
    #define DSI_VACT_PERIOD                     _BIT13
    #define DSI_VFP_PERIOD                      _BIT12
    #define DSI_VMCTL_STATE                     _BITMASK(10:0)
...
#define REG_DSI_RESERVED    0x0174              //Reserved Register
    #define DSI_RESERVED                        _BITMASK(31:0)
...
#define REG_DSI_BIST_PATTE_RN    0x0178         //DSI Bist Pattern Register
    #define DSI_BIST_PATTERN                    _BITMASK(31:0)
    //DSI BIST test register for HW verification
#define REG_DSI_BIST_CON        0x017C          //DSI Bist Control Register

    #define DSI_BIST_TIMIING                    _BITMASK(23:16)
    #define DSI_BIST_LANE_NUM                   _BITMASK(11:8)
    #define DSI_SELF_PAT_MODE                   _BIT6
    #define DSI_BIST_HS_FREE                    _BIT4
    #define DSI_BIST_SPECIFIED_PATTERN          _BIT3
    #define DSI_BIST_FIX_PATTERN                _BIT2
    #define DSI_BIST_ENABLE                     _BIT1
    #define DSI_BIST_MODE                       _BIT0
...
#define REG_DSI_VM_CMD_DATA10        0x0180         //DSI Video Mode Command Packet Data Byte 16~19 Register
    #define DSI_VM_LONG_PKT_WORD16_19               _BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA14        0x0184         //DSI Video Mode Command Packet Data Byte 20~23 Register
    #define DSI_VM_LONG_PKT_WORD20_23               _BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA18        0x0188         //DSI Video Mode Command Packet Data Byte 24~27 Register
    #define DSI_VM_LONG_PKT_WORD24_27               _BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA1C        0x018C         //DSI Video Mode Command Packet Data Byte 28~31 Register
    #define DSI_VM_LONG_PKT_WORD28_31               _BITMASK(31:0)


#define REG_DSI_CMDQ_N        0x0200                //DSI Command Queue
    #define DSI_DATA_1                              _BITMASK(31:24)
    #define DSI_DATA_0                              _BITMASK(23:16)
    #define DSI_DATA_ID                             _BITMASK(15:8)
    #define DSI_RESV                                _BITMASK(7:6)
    #define DSI_TE                                  _BIT5
    #define DSI_CL                                  _BIT4
    #define DSI_HS                                  _BIT3
    #define DSI_BTA                                 _BIT2
    #define DSI_TYPE                                _BITMASK(1:0)
