...
#define HAL_DISP_UTILITY_CMDQ_ID_DEVICE2 (2)
#define HAL_DISP_UTILITY_CMDQ_ID_DMA     (3)
#define HAL_DISP_UTILITY_CMDQ_NUM        (4)
...
#define HAL_DISP_IRQ_TOP_FLAG_REG(id)                                 \
    ((id == HAL_DISP_DEVICE_ID_0)   ? DISP_TOP0_REG_INTR_STATUS_GRP_A \
     : (id == HAL_DISP_DEVICE_ID_1) ? DISP_TOP1_REG_INTR_STATUS_GRP_A \
                                    : DISP_TOP2_REG_INTR_STATUS_GRP_A)
#define HAL_DISP_IRQ_TOP_RAWFLAG_REG(id)                                  \
    ((id == HAL_DISP_DEVICE_ID_0)   ? DISP_TOP0_REG_INTR_RAW_STATUS_GRP_A \
     : (id == HAL_DISP_DEVICE_ID_1) ? DISP_TOP1_REG_INTR_RAW_STATUS_GRP_A \
                                    : DISP_TOP2_REG_INTR_RAW_STATUS_GRP_A)
...
#define HAL_DISP_IRQ_TOP_CLEAR_REG_ALL(id)                 \
    ((id == HAL_DISP_DEVICE_ID_0)   ? DISP_TOP0_REG_SW_RST \
     : (id == HAL_DISP_DEVICE_ID_1) ? DISP_TOP1_REG_SW_RST \
                                    : DISP_TOP2_REG_SW_RST)
...
#define HAL_DISP_UTILITY_CMDQDEV_WAIT_DONE_EVENT(id)                        \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? E_MHAL_CMDQEVE_DISP_0_INT \
     ...
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE2 ? E_MHAL_CMDQEVE_DISP_2_INT \
                                                : HAL_DISP_UTILITY_CMDQDMA_WAIT_DONE_EVENT(id))
#define HAL_DISP_UTILITY_CMDQDMA_WAIT_DONE_EVENT(id) \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DMA ? E_MHAL_CMDQEVE_DISP_WDMA_0_INT : 0)
...
#define HAL_DISP_UTILITY_DISP_TO_CMDQDEV_RAW(id)                                           \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? DISP_TOP0_REG_CMDQ_INTR_RAW_STATUS_GRP_A \
     ...
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE2 ? DISP_TOP2_REG_CMDQ_INTR_RAW_STATUS_GRP_A \
                                                : 0)
#define HAL_DISP_UTILITY_DISP_TO_CMDQDEV_CLEAR(id)                                     \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? DISP_TOP0_REG_CMDQ_INTR_STATUS_GRP_A \
     ...
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE2 ? DISP_TOP2_REG_CMDQ_INTR_STATUS_GRP_A \
                                                : 0)
...
#define REG_HAL_DISP_UTILIYT_CMDQDEV_IN_PROCESS(id)                       \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? REG_DISP_MOPG_BK02_0F_L \
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE1 ? REG_DISP_MOPG_BK12_0F_L \
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE2 ? REG_DISP_MOPG_BK22_0F_L \
                                                : 0)
...
#define REG_HAL_DISP_UTILIYT_CMDQDMA_IN_PROCESS(id) \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DMA ? DISP_CVBS_REG_SC_DMA_DUMMY0 : 0)
...
#define REG_HAL_DISP_UTILITY_CMDQ_WAIT_CNT(id)                            \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? REG_DISP_MOPG_BK02_1F_L \
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE1 ? REG_DISP_MOPG_BK12_1F_L \
                                                : REG_DISP_MOPG_BK22_1F_L)

#define REG_CMDQ_WAIT_CNT_MSK   (0xFF00)
#define REG_CMDQ_WAIT_CNT_SHIFT (8)

#define REG_HAL_DISP_UTILITY_CMDQ_FLIP_CNT(id)                            \
    ((id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE0   ? REG_DISP_MOPG_BK02_2F_L \
     : (id) == HAL_DISP_UTILITY_CMDQ_ID_DEVICE1 ? REG_DISP_MOPG_BK12_2F_L \
                                                : REG_DISP_MOPG_BK22_2F_L)
...
#define REG_FLM_COUNT                        (DISP_TOP0_REG_RESERVED_30)
#define mask_of_reg_frame_done_count         (0xf000)
#define shift_of_reg_frame_done_count        (12)
#define REG_FRAME_DONE_COUNT                 ((DISP_TOP0_REG_RESERVED_30))
